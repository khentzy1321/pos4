<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="navbar-brand-wrapper d-flex justify-content-center bg-secondary">
<div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
  <a class="navbar-brand brand-logo brand-logo text-light" href="{{url('admin/dashboard')}}"><img src="/images/logo.png" style="width: 20%" alt="logo"/>Mdc Canteen</a>
...
<div class="navbar-menu-wrapper d-flex align-items-center justify-content-end bg-secondary">
